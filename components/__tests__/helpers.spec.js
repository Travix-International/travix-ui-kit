const getClassNamesWithMods = require('../_helpers.js').getClassNamesWithMods;
const getDataAttributes = require('../_helpers.js').getDataAttributes;
const ejectOtherProps = require('../_helpers.js').ejectOtherProps;
const warnAboutDeprecatedProp = require('../_helpers.js').warnAboutDeprecatedProp;
